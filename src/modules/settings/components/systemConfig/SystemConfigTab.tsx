        ...
        <Card className="rounded-[15px] p-5 shadow-none border-none">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs ">
              <thead>
                <tr className="border-b border-border bg-muted text-center align-middle text-[12px] uppercase tracking-wide text-muted-foreground">
              ...
              <tbody>
                {config.advisoryChanges.map((change) => (
                  <tr
                    key={change.id}
                    className="text-center border-b border-border last:border-b-0 text-[14px]"
                  >
                    <td className="py-3 pr-3">
                      <span className="flex items-center gap-2 font-medium text-foreground">
                        <Avatar className="size-6">
                          <AvatarFallback className="bg-success-subtle  font-semibold text-success">
